...
// Lightweight authenticated fetch wrapper (matches the red-team `apiFetch`
// shape so the rest of this component can stay identical between the two
// clients). The academy doesn't have a shared `@/lib/api` helper.
